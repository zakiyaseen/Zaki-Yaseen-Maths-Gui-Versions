...
def check_username_input():
    ...
    if username_input.strip() =="":
        ...
        userinput = {"username:": username_input}
        with open("data.json", "w") as file:
...
def start():
    ...
    add_appliance_button = Button(window, text="Continue to math game", command= check_username_input)
